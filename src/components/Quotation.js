...
const bgcolor=["#DFDBE5","#DEE5DB","#e5dbdb","#d9b9b9"]
function Quotation(){
    ...
    return (
        <div className="mx-16 my-8">
            <ul className="flex flex-wrap justify-around items-stretch">
                {quotation.map((ele)=>(
                    <li className="relative w-48 h-48 p-6 m-4 leading transform rotate-2 shadow-md" style={{background: bgcolor[Math.floor(Math.random()*bgcolor.length)]}} key={ele.id}>
