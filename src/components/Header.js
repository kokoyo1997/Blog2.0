  ...
  return (
    ...
    <header className="relative w-full px-4 py-2 bg-gray-600 flex flex-row justify-between items-center text-gray-200 font-light">
      <div className="z-40 self-start">
        <h1><a href={`${process.env.PUBLIC_URL}/index.html`} className="text-zero block w-10 h-10 md:w-10 md:h-10" style={{backgroundImage:`url('${process.env.PUBLIC_URL}/img/logo2.png')`,backgroundSize:"cover"}}>k</a></h1>
      </div>
      ...
      <div className="flex flex-col justify-end space-y-6 text-right bg-gray-600 md:space-y-0">
        ...
        <div className="flex flex-col space-y-4 text-right tracking-widest bg-gray-600 md:flex md:flex-row md:static md:space-x-8 md:space-y-0 md:tracking-wide">
          <a href={`${process.env.PUBLIC_URL}/index.html`} className="cursor-pointer hover:text-red-300"><span className="iconfont pr-1">&#xe7f9;</span>HOME</a>
          <a href={`${process.env.PUBLIC_URL}/todo`} className="cursor-pointer hover:text-red-300"><span className="iconfont pr-1">&#xe804;</span>TODO</a>
          <a href={`${process.env.PUBLIC_URL}/about`} className="cursor-pointer hover:text-red-300"><span className="iconfont pr-1">&#xe81d;</span>ABOUT</a>
